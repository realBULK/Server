...
public class EmojiRecordController {
    ...
    public CustomResponse<EmojiRecordResponseDto> createEmoji(
        ...
        return CustomResponse.onSuccess(GeneralSuccessCode.OK, emojiRecordService.createEmoji(requestDto));
    }
    ...
    public CustomResponse<EmojiRecordResponseDto> updateEmoji(
            ...
            @RequestBody EmojiRecordUpdateRequestDto requestDto) {
        return CustomResponse.onSuccess(GeneralSuccessCode.OK, emojiRecordService.updateEmoji(emojiId, requestDto));
    }
    ...
    public ResponseEntity<CustomResponse<Void>> deleteEmoji(
            @Parameter(description = "이모지 기록 ID") @PathVariable Long emojiId) {
        emojiRecordService.deleteEmoji(emojiId);
